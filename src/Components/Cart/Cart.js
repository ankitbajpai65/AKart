...
const Cart = () => {
  ...
  return (
    <div
      className="cart container-fluid"
      style={{ minHeight: !isLogin && "70vh", background: "white" }}
    >
      {isLogin ? (
        <div className="row d-flex justify-content-center cartDiv">
          <div
            className={
              isEmpty
                ? "col-md-7 col-11 catalogue emptyCart"
                : "col-md-7 col-11 catalogue"
            }
          >
            {isEmpty ? (
              <div>
                ...
                <button className="btn btn-primary" onClick={shopBtnClicked}>
                  Shop Now
                </button>
              </div>
            ) : (
          ...
          <div className="col-md-3 col-11 totalPrice ms-md-4 d-flex flex-column justify-space-around">
            ...
            <div className="row priceSec">
              <span className="type col-6">
                Price({totalUniqueItems} items)
              </span>
            ...
            <div className="row priceSec">
              ...
              <span className="cost col-2 offset-3 text-primary fw-semibold">
                FREE
              </span>
            </div>
            <div className="row priceSec">
              <span className="type col-6 fw-bold">Total Amount</span>
              <span className="cost col-2 offset-3 fw-bold">
                ₹{cartTotal}/-
              </span>
            </div>
          </div>
        ...
        <div className="warningDiv d-flex flex-column">
          <span className="warning text-black mb-5">
            Please Login to see the cart
          </span>
          <Link to="/login">
